  ...
  <div class="flex flex-col justify-between w-96 h-[90vh] border rounded-2xl">
    ...
    <section class="grow flex flex-col justify-between">
      <div
        ...
        <ul class="relative z-20 p-3 flex flex-col gap-4 font-medium">
          <li class="flex items-end gap-1">
            <div class="bg-white border border-slate-300 py-3 px-4 rounded-ss-2xl rounded-e-2xl inline-block max-w-[65%]">
          ...
          <li class="flex items-end flex-row-reverse gap-2">
      ...
      <div class="flex justify-between items-center pe-3 hover:shadow transition-all">
        <input type="text"
          class="grow border-0 border-transparent focus:border-transparent focus:ring-0 caret-orange-700" placeholder="Send message...">
